...
import { role, brandsData, subjectsData, gradesData } from "@/lib/data";
...
const GradeListPage = () => {
  // 🔗 Gabungkan data grade dengan subject dan brand-nya
  const gradesWithSubjectAndBrand: Grade[] = gradesData.map((grade) => {
  ...
  return (
    <div className="bg-white p-4 rounded-md flex-1 m-4 mt-0">
      ...
      <Table
        columns={columns}
        renderRow={renderRow}
        data={gradesWithSubjectAndBrand}
      />
